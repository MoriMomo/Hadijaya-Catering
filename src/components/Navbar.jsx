                ...
                <div className="flex justify-between items-center h-16 md:h-20">
                    ...
                    <div className="md:hidden">
                        <button
                            ...
                            className="p-2 text-slate-600 hover:text-orange-700 hover:bg-orange-50 rounded-lg transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-2"
