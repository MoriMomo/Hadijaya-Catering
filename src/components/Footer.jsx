...
const Footer = () => {
    return (
        <footer className="bg-[#F5F3ED] border-t border-stone-200/80">
            {/* Main Footer Content */}
            <div className="py-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 lg:gap-16">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-sm list-none p-0">
                                <li>
                                    <Link to="/" className="text-slate-600 hover:text-accent-600 transition no-underline">
                                        Beranda
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/menu" className="text-slate-600 hover:text-accent-600 transition no-underline">
                                        Menu & Harga
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/about" className="text-slate-600 hover:text-accent-600 transition no-underline">
                                        Tentang Kami
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/order" className="text-slate-600 hover:text-accent-600 transition no-underline font-semibold">
                                        Reservasi
                                    </Link>
                                </li>
                            </ul>
                            ...
                            <address className="space-y-3 text-sm text-slate-600 not-italic">
                                ...
                                <div className="space-y-2 pt-2 text-xs md:text-sm">
                                    <p className="flex items-center gap-2 m-0">
                                        ...
                                        <a href="tel:081211212185" className="text-slate-600 hover:text-accent-600 transition no-underline">
                                            Telepon: 0812 1121 2185
                                        </a>
                                    </p>
                                    <p className="flex items-center gap-2 m-0">
                                        <span className="text-slate-400" aria-hidden="true">💬</span>
                                        <a href="https://wa.me/6281211212185" target="_blank" rel="noopener noreferrer" className="text-slate-600 hover:text-accent-600 transition no-underline">
                                            WhatsApp: 0812 1121 2185
                                        </a>
                                    </p>
                                    <p className="flex items-center gap-2 m-0">
                                        <span className="text-slate-400" aria-hidden="true">✉️</span>
                                        <a href="mailto:pt.hjcitra@gmail.com" className="text-slate-600 hover:text-accent-600 transition no-underline">
            ...
            {/* Copyright */}
            <div className="py-6 border-t border-stone-200/80 bg-[#F5F3ED]">
