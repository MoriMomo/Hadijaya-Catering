...
const Home = () => {
    ...
    return (
        <div className="pb-12 bg-white transition-colors duration-300">
            ...
            <div className="relative bg-[#faf9f6] overflow-hidden transition-colors duration-300 min-h-[90vh] flex items-center">
                ...
                <div className="max-w-7xl mx-auto px-6 w-full relative z-10 grid md:grid-cols-2 gap-12 lg:gap-16 items-center py-16 md:py-24">
                    ...
                    >
                        ...
                        <motion.div variants={fadeInUp} className="inline-flex items-center gap-2.5 px-4 py-2 bg-white/70 backdrop-blur-md rounded-full shadow-sm border border-[#e2e8f0]">
                            <span className="relative flex h-2.5 w-2.5">
                                ...
                                <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-[#d35400]"></span>
                            </span>
                            <span className="text-[#8c593b] font-semibold tracking-widest text-[11px] uppercase">Sejak 1999</span>
                        </motion.div>

                        {/* Clearer hierarchy - title + subtitle closer together */}
                        <motion.div variants={fadeInUp} className="space-y-5">
                            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-serif font-bold text-[#2c2520] leading-[1.1] tracking-tight">
                                Cita Rasa <br />
                                <span className="text-[#d35400] relative italic pr-4">
                                    Legendaris
                                    <svg className="absolute w-full h-3 -bottom-1 left-0 text-[#fde0d1] -z-10" viewBox="0 0 100 10" preserveAspectRatio="none">
                                        <path d="M0 5 Q 50 10 100 5" fill="none" stroke="currentColor" strokeWidth="8" strokeLinecap="round" />
                                    </svg>
                                </span>
                            </h1>
                            <p className="text-lg sm:text-xl text-[#5c5046] leading-relaxed max-w-lg font-light">
                        ...
                        <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 pt-6">
                            <button
                                ...
                                className="bg-[#d35400] hover:bg-[#e65100] text-white px-8 py-4.5 rounded-full font-bold premium-shadow transition-all duration-300 transform hover:-translate-y-1 text-base tracking-wide text-center flex items-center justify-center gap-3 w-full sm:w-auto"
                            >
                            ...
                            <button
                                ...
                                className="bg-transparent hover:bg-[#fde0d1]/30 text-[#d35400] border-2 border-[#d35400] px-8 py-4.5 rounded-full font-bold transition-all duration-300 text-base tracking-wide text-center w-full sm:w-auto hover:shadow-lg focus:ring-4 focus:ring-[#d35400]/20"
                            >
                                Pesan Sekarang
                            </button>
                        </motion.div>
                        ...
                        <motion.div variants={fadeInUp} className="flex items-center gap-5 pt-8 mt-4 border-t border-[#e2e8f0]/80">
                            <div className="flex items-center gap-3">
                                <div className="flex -space-x-3">
                                    {[...Array(4)].map((_, i) => (
                                        <div key={i} className="w-10 h-10 rounded-full bg-gradient-to-tr from-[#d35400] to-[#f39c12] border-[3px] border-[#faf9f6] flex items-center justify-center text-white text-xs font-bold shadow-sm relative z-10 hover:z-20 hover:scale-110 transition-transform duration-300">
                    ...
                    >
                        ...
                        <div className="absolute -inset-4 bg-gradient-to-tr from-[#fde0d1]/60 to-[#faf9f6] rounded-[2.5rem] transform rotate-3 scale-105 opacity-70 blur-xl"></div>
                        <div className="absolute -inset-4 bg-gradient-to-bl from-[#d35400]/10 to-transparent rounded-[2.5rem] transform -rotate-2 scale-100"></div>
                        ...
                        <motion.div
                            ...
                            className="absolute -right-6 md:-right-10 bottom-12 z-20 bg-white p-4 rounded-2xl premium-shadow border border-[#f0ece6] flex items-center gap-4 hidden sm:flex"
                        >
                            <div className="w-12 h-12 rounded-full bg-[#fdf5f0] flex items-center justify-center text-[#d35400]">
                                <Award className="w-6 h-6" />
                            </div>
                            <div>
                                <p className="text-sm text-[#5c5046] font-medium">Spesialis</p>
                                <p className="text-base text-[#2c2520] font-bold font-serif">Nasi Uduk Hijau</p>
                            </div>
                        </motion.div>
                    </motion.div>
                </div>
                    ...
                    >
                        {[
                            ...
                            <motion.div key={idx} variants={fadeInUp} className="text-center group">
                                <div className="w-20 h-20 mx-auto bg-slate-50 rounded-full flex items-center justify-center text-orange-700 mb-8 group-hover:bg-orange-500 group-hover:text-white transition duration-500 shadow-sm border border-slate-100">
            ...
            {/* CTA - Keep at bottom */}
            <div className="py-20 bg-orange-600 relative overflow-hidden text-center px-6 transition-colors duration-300">
